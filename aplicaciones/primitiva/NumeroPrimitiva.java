...
public class NumeroPrimitiva implements Comparable<NumeroPrimitiva> {
    ...
    public boolean equals(Object numPri) {
        return (numPri instanceof NumeroPrimitiva) && ((NumeroPrimitiva) numPri).numero == this.numero;
    }
    ...
    public int compareTo(NumeroPrimitiva numPri) {
        return this.numero - numPri.numero;
    }
